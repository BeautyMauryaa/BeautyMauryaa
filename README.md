...
<h3 align="center">Full-Stack Developer | MERN & PERN | C++ & DSA | Exploring DevOps & Cloud</h3>
...
- 💻 I am a Software Development Intern with hands-on experience in full-stack web development.
- 🚀 I work with both **MERN and PERN stacks**, building web applications, APIs, and backend services.
...
- ☁️ Exploring **DevOps, Cloud Computing, Docker, deployment, and system design** as part of my long-term career journey.
- 🧠 Interested in backend development, API design, authentication, databases, and understanding how modern applications work behind the scenes.
- 🌱 Beyond technology, I am actively working on improving my **communication, confidence, problem-solving, and ability to explain ideas clearly**.
- 🎯 My long-term goal is to grow into a **DevOps / Cloud Engineer** with a strong foundation in software development and backend systems.
- 💬 Ask me about **JavaScript, React, Node.js, Express.js, MongoDB, PostgreSQL, REST APIs, git/github or C++**.
...
<p align="center">
  ...
  <img src="./animesher.com_eating-anime-girl-gif-1922951.gif" alt="Anime Girl Eating" width="350"/>
</p>
...
- 🏗️ System Design
- 🗣️ Communication & Technical Explanation

---

### 🚀 My Career Direction

I am building my foundation as a **Full-Stack Developer** while gradually moving toward **DevOps and Cloud Engineering**.

I want to understand not only how to build applications, but also how they are deployed, scaled, maintained, and made reliable in real-world environments.

For me, learning is not limited to technology. I am also working on becoming a better communicator, problem-solver, and professional—because I believe a strong engineer needs both **technical depth and the ability to think, communicate, and collaborate well**.
